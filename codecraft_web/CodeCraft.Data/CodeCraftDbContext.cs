...
namespace CodeCraft.Data
{
    public class CodeCraftDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        public DbSet<CodeCraft.Data.Models.InstructorTestimonial> InstructorTestimonial { get; set; } = default!;
        public DbSet<CodeCraft.Data.Models.Student> Student { get; set; } = default!;
        public DbSet<CodeCraft.Data.Models.StudentTestimonial> StudentTestimonial { get; set; } = default!;
    }
}
