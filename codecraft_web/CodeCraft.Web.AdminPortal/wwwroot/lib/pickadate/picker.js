  ...
  function b(h, i, k, m) {
    function o() {
      return b._.node(
        ...
        b._.node(
          ...
          b._.node(
            "div",
            b._.node("div", C.component.nodes(x.open), z.box),
            z.wrap,
          ),
          z.frame,
        ),
          ...
          "mousedown click": function (b) {
            ...
            c != C.$holder[0] &&
              ...
              "mousedown" != b.type ||
                ...
                (b.preventDefault(), C.$holder.eq(0).focus()));
          },
        })
        .on(
          "click",
          ...
          function () {
            ...
            (e = e && (e.type || e.href ? e : null)),
              (d || (e && !a.contains(C.$root[0], e))) &&
                C.$holder.eq(0).focus(),
              !d && c.nav
                ? C.set("highlight", C.component.item.highlight, { nav: c.nav })
                : !d && "pick" in c
                  ? (C.set("select", c.pick), y.closeOnSelect && C.close(!0))
                  : c.clear
                    ? (C.clear(), y.closeOnClear && C.close(!0))
                    : c.close && C.close(!0);
          },
        );
    }
    function s() {
      ...
      !0 === y.hiddenName
        ? ((b = h.name), (h.name = ""))
        : ((b = [
            "string" == typeof y.hiddenPrefix ? y.hiddenPrefix : "",
            "string" == typeof y.hiddenSuffix ? y.hiddenSuffix : "_submit",
          ]),
          (b = b[0] + h.name + b[1])),
        (C._hidden = a(
          '<input type=hidden name="' +
            b +
            '"' +
            (A.data("value") || h.value
              ? ' value="' + C.get("select", y.formatSubmit) + '"'
              : "") +
            ">",
        )[0]),
    ...
    function v(a) {
      ...
      (32 == b || c || (!x.open && C.component.key[b])) &&
        (a.preventDefault(),
        a.stopPropagation(),
    ...
    var w = !1,
      ...
      C = (B.prototype = {
        ...
        start: function () {
          return x && x.start
            ...
            : ((x.methods = {}),
              ...
              (C.$root = a(
                '<div class="' + z.picker + '" id="' + h.id + '_root" />',
              )),
              q(),
              ...
              p(),
              y.containerHidden
                ? a(y.containerHidden).append(C._hidden)
                : A.after(C._hidden),
        ...
        render: function (b) {
          return (
            b
              ? ((C.$holder = a(o())), r(), C.$root.html(C.$holder))
              : C.$root.find("." + z.box).html(C.component.nodes(x.open)),
            C.trigger("render")
          );
        },
        stop: function () {
                ...
                l
                  ...
                  .on("keydown." + x.id, function (c) {
                    ...
                    27 == d
                      ? C.close(!0)
                      : g != C.$holder[0] || (!f && 13 != d)
                        ? a.contains(C.$root[0], g) &&
                          13 == d &&
                          (c.preventDefault(), g.click())
                        : (c.preventDefault(),
                          f
                            ? b._.trigger(C.component.key.go, C, [
                                b._.trigger(f),
                              ])
                            : C.$root
                                .find("." + z.highlighted)
                                .hasClass(z.disabled) ||
                              (C.set("select", C.component.item.highlight),
        ...
        set: function (b, c, d) {
          ...
          if (((d = g && a.isPlainObject(c) ? c : d || {}), b)) {
            ...
            for (e in h)
              (f = h[e]),
                e in C.component.item &&
                  (void 0 === f && (f = null), C.component.set(e, f, d)),
                ("select" != e && "clear" != e) ||
                  !y.updateInput ||
                  A.val("clear" == e ? "" : C.get(e, y.format)).trigger(
                    "change",
                  );
            C.render();
          }
        ...
        get: function (a, c) {
          ...
          if (a in C.component.item) {
            if ("string" == typeof c) {
              ...
              return d
                ? b._.trigger(C.component.formats.toString, C.component, [c, d])
                : "";
            }
