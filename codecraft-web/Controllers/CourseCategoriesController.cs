...
namespace codecraft_web.Controllers
{
    public class CourseCategoriesController : Controller
    {
        ...
        public CourseCategoriesController(codecraft_webDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreatedAt,UpdatedAt")] CourseCategory courseCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Name,CreatedAt,UpdatedAt")] CourseCategory courseCategory)
        {
